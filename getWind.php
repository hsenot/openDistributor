<?php
    ...
    try {
        ...
        $p_arr = array('REQUEST'=>'GetFeatureInfo','EXCEPTIONS'=>'application/vnd.ogc.se_xml','BBOX'=>($p_x-$gs).','.($p_y-$gs).','.($p_x+$gs).','.($p_y+$gs),'SERVICE'=>'WMS','INFO_FORMAT'=>'application/json','QUERY_LAYERS'=>'_3tier:Wind_Speed_Global_5km_80m_3TIER','FEATURE_COUNT'=>50,'Layers'=>'_3tier:Wind_Speed_Global_5km_80m_3TIER','WIDTH'=>512,'HEIGHT'=>512,'format'=>'image/jpeg','srs'=>'EPSG:4326','version'=>'1.1.1','x'=>256,'y'=>256);
...
// http://irena.masdar.ac.ae:8080/geoserver/_3tier/wms?REQUEST=GetFeatureInfo&EXCEPTIONS=application%2Fvnd.ogc.se_xml&BBOX=138.625172%2C-44.885483%2C150.329672%2C-33.180983
        ...
        $output = json_encode(array("speed"=>$json_res['features'][0]['properties']['GRAY_INDEX']));
